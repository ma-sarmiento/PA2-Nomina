...
public class Empleado implements Serializable {
    ...
    public int getSalariosMinimos() { return salariosMinimos; }
    ...
    public double getSalarioTot() { return salarioTot; }
    public void setSalarioTot(double salarioTot) { this.salarioTot = salarioTot; }
